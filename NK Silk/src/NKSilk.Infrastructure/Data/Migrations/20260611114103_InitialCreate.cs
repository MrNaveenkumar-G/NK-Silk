        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MrpPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Sku = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsFeatured = table.Column<bool>(type: "bit", nullable: false),
                    FabricType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    MaterialComposition = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Gsm = table.Column<int>(type: "int", nullable: true),
                    WashCare = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Occasion = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Collection = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
